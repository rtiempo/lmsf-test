...
export default function AddCategoryModal({ categoryLists, setCategoryLists }) {
    ...
    useEffect(() => {
        ...
        const addCategoryListiner = EventEmitter.addListener("addMainSubject", addCategory)
        return () => {
                ...
                <Grid p={5} container spacing={2} columns={16}>
                    ...
                    <Grid item xs={16} mt={-5}>
                        ...
                        >
                            ...
                            /> */}
                            <InputBase fullWidth sx={{ ml: 1, flex: 1 }} placeholder="Add a category and press Enter" />
